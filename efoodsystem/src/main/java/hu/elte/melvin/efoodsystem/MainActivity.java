...
public class MainActivity extends AppCompatActivity implements BaseFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainViewModel.getState().observe(this, new Observer<MainViewModel.Enums.state>() {
            @Override
            public void onChanged(@Nullable MainViewModel.Enums.state state) {
                switch(state) {
                    case Base:
        ...
        mainViewModel.isIsloggedIn().observe(this, new Observer<Boolean>() {
            @Override
    ...
    public void replaceFragment(Fragment launchFragment) {
        ...
        ft.replace(R.id.fragment_container, launchFragment).commit();
    }
